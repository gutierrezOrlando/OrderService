package com.readiness.tareaservice.repository;

import com.readiness.tareaservice.OrderServiceApp;
import com.readiness.tareaservice.config.Constants;
import com.readiness.tareaservice.config.audit.AuditEventConverter;
import com.readiness.tareaservice.domain.PersistentAuditEvent;
...
import static com.readiness.tareaservice.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
